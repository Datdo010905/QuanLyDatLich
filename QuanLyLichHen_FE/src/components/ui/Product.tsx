      ...
      <div className="product">
        ...
        <div className="row" id="ds-dichvu">
          ...
          <div className="col-s-6 col-m-4 col-x-3">
            <div className="item">
              <br />
              <img className="pic_item" title="cat-goi-combo-2" src="img/product/cat-goi-combo-2.png" /> <br /><br />
              <a className="product-name" href="#">Cắt gội Combo 2</a><br /><br />
              <span className="giamgia">55 phút</span>
              <br />
              <div className="gia"><span className="product-price">199.000 VNĐ</span></div>
            </div>
          </div>
          <div className="col-s-6 col-m-4 col-x-3">
            <div className="item">
              <br />
              <img className="pic_item" title="cat-goi-combo-3" src="img/product/cat-goi-combo-3.png" /> <br /><br />
              <a className="product-name" href="#">Cắt gội Combo 3</a><br /><br />
              <span className="giamgia">65 phút</span>
              <br />
              <div className="gia"><span className="product-price">299.000 VNĐ</span></div>
            </div>
          </div>
          <div className="col-s-6 col-m-4 col-x-3">
            <div className="item">
              <br />
              <img className="pic_item" title="cat-xa-tao-kieu" src="img/product/cat-xa-tao-kieu.png" /> <br /><br />
              <a className="product-name" href="#">Cắt xả tạo kiểu</a><br /><br />
              <span className="giamgia">30 phút</span>
              <br />
              <div className="gia"><span className="product-price">90.000 VNĐ</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="row" id="ds-chamsoc">
          <div className="col-s-6 col-m-4 col-x-3">
            <div className="item">
              <br />
              <img className="pic_item" title="goi-thu-gian" src="img/product/goi-thu-gian.png" /> <br /><br />
              <a className="product-name" href="#">Gội thư giãn</a><br /><br />
              <span className="giamgia">15 phút</span>
              <br />
              <div className="gia"><span className="product-price">59.000 VNĐ</span></div>
            </div>
          </div>
          <div className="col-s-6 col-m-4 col-x-3">
            <div className="item">
              <br />
              <img className="pic_item" title="goi-thu-gian-1" src="img/product/goi-thu-gian-1.png" /> <br /><br />
              <a className="product-name" href="#">Gội thư giãn cổ vai gáy</a><br /><br />
              <span className="giamgia">30 phút</span>
              <br />
              <div className="gia"><span className="product-price">99.000 VNĐ</span></div>
            </div>
          </div>
          <div className="col-s-6 col-m-4 col-x-3">
            <div className="item">
              <br />
              <img className="pic_item" title="goi-thu-gian-2" src="img/product/goi-thu-gian-2.png" /> <br /><br />
              <a className="product-name" href="#">Gội Combo 2</a><br /><br />
              <span className="giamgia">25 phút</span>
              <br />
              <div className="gia"><span className="product-price">159.000 VNĐ</span></div>
            </div>
          </div>
          <div className="col-s-6 col-m-4 col-x-3">
            <div className="item">
              <br />
              <img className="pic_item" title="goi-thu-gian-3" src="img/product/goi-thu-gian-3.png" /> <br /><br />
              <a className="product-name" href="#">Gội Combo 3</a><br /><br />
              <span className="giamgia">35 phút</span>
              <br />
              <div className="gia"><span className="product-price">239.000 VNĐ</span></div>
            </div>
          </div>
        </div>
